...
public class EnemyInst3 : MonoBehaviour
{
...
public List<string> words = new List<string>
{
    ...
    public static EnemyInst3 Instance { get; private set; }
    ...
    {   
        numoflives=3;
        Debug.Log("EVO MEEEEEEEEEEEEEEEEE");
    ...
    public void addToWord(String word) {
        Debug.Log("evo me iz enemyinst2 i slovo je "+word);
        
        odabranarijec+=word;
        Debug.Log("evo me iz enemyinst2 i odabrana rijec je "+ odabranarijec);
    ...
    void Pobjeda() {
           ...
           Debug.Log("Bravo preso si level");
                 if(GlobalManagerScript.level==6)
                 GlobalManagerScript.level=7;
                 GlobalManagerScript.zadnjiodigranlvl=6;
         ...
         if (Input.GetKeyDown(KeyCode.Return) || Input.GetKeyDown(KeyCode.KeypadEnter))
        {
            // Your code to be executed when Enter key is pressed
               Debug.Log("Bravo preso si level");
                 ...
                 if(GlobalManagerScript.level<7)
                 GlobalManagerScript.level=7;
                 GlobalManagerScript.zadnjiodigranlvl=6;
                  loading.Instance.LoadScene("Donelvl1");
